...
public class MyStackUp {
    ...
    public void push(Object obj) throws MyStackException {//压栈方法
        if (this.index>=objs.length-1){
            MyStackException mse =  new MyStackException("栈已满");//自己写的异常类
            throw mse;//手动抛异常
        }
        index++;
        this.objs[index]=obj;
    ...
    public Object pop() throws Exception{//弹栈的方法
        if (index<0){
            MyStackException mse =  new MyStackException("栈已空");
            throw mse;
        }
